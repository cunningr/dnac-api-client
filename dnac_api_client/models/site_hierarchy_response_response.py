...
class SiteHierarchyResponseResponse(object):
    ...
    def __init__(self, access_good_count=None, access_total_count=None, application_bytes_total_count=None, application_good_count=None, application_health=None, application_total_count=None, client_health_wired=None, client_health_wireless=None, client_issue_count=None, client_number_of_issues=None, core_good_count=None, core_total_count=None, distribution_good_count=None, distribution_total_count=None, healthy_clients_percentage=None, healthy_network_device_percentage=None, network_health_access=None, network_health_average=None, network_health_core=None, network_health_distribution=None, network_health_others=None, network_health_router=None, network_health_wireless=None, network_number_of_issues=None, number_of_clients=None, number_of_network_device=None, number_of_wired_clients=None, number_of_wireless_clients=None, overall_good_devices=None, parent_site_id=None, parent_site_name=None, router_good_count=None, router_total_count=None, site_id=None, site_name=None, site_type=None, wired_good_clients=None, wireless_device_good_count=None, wireless_device_total_count=None, wireless_good_clients=None):  # noqa: E501
