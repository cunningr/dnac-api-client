...
class TemplateDeploymentStatusDTODevices(object):
    ...
    def __init__(self, duration=None, ip_address=None, name=None, start_time=None, end_time=None, device_id=None, status=None):  # noqa: E501
        """TemplateDeploymentStatusDTODevices - a model defined in OpenAPI"""  # noqa: E501
