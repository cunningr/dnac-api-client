...
class ImageInfoListResponseResponse(object):
    ...
    def __init__(self, application_type=None, image_name=None, profile_info=None, image_integrity_status=None, image_series=None, is_tagged_golden=None, version=None, extended_attributes=None, md5_checksum=None, file_service_id=None, image_source=None, applicable_devices_for_image=None, feature=None, file_size=None, vendor=None, name=None, created_time=None, sha_check_sum=None, family=None, image_type=None, import_source_type=None, image_uuid=None):  # noqa: E501
        """ImageInfoListResponseResponse - a model defined in OpenAPI"""  # noqa: E501
