...
class DiscoveryJobNIOListResultResponse(object):
    ...
    def __init__(self, job_status=None, snmp_status=None, cli_status=None, discovery_status=None, ip_address=None, ping_status=None, attribute_info=None, netconf_status=None, http_status=None, inventory_collection_status=None, inventory_reachability_status=None, name=None, start_time=None, end_time=None, id=None, task_id=None):  # noqa: E501
        """DiscoveryJobNIOListResultResponse - a model defined in OpenAPI"""  # noqa: E501
