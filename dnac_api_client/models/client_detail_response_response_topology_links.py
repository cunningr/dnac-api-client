...
class ClientDetailResponseResponseTopologyLinks(object):
    ...
    def __init__(self, link_status=None, port_utilization=None, source=None, label=None, id=None, target=None):  # noqa: E501
        """ClientDetailResponseResponseTopologyLinks - a model defined in OpenAPI"""  # noqa: E501
