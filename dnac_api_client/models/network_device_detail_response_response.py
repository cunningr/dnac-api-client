...
class NetworkDeviceDetailResponseResponse(object):
    ...
    def __init__(self, overall_health=None, management_ip_addr=None, serial_number=None, nw_device_name=None, op_state=None, platform_id=None, nw_device_id=None, sys_uptime=None, mode=None, reset_reason=None, nw_device_role=None, up_time=None, memory_score=None, nw_device_family=None, mac_address=None, connected_time=None, software_version=None, sub_mode=None, nw_device_type=None, cpu_score=None):  # noqa: E501
        """NetworkDeviceDetailResponseResponse - a model defined in OpenAPI"""  # noqa: E501
