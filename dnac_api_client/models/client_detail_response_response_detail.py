...
class ClientDetailResponseResponseDetail(object):
    ...
    def __init__(self, host_name=None, channel=None, data_rate=None, health_score=None, ssid=None, issue_count=None, frequency=None, last_updated=None, dns_failure=None, onboarding_time=None, host_type=None, onboarding=None, id=None, auth_type=None, host_ip_v4=None, host_ip_v6=None, connected_device=None, rssi=None, avg_rssi=None, rx_bytes=None, host_version=None, vlan_id=None, host_os=None, client_connection=None, ap_group=None, user_id=None, avg_snr=None, tx_bytes=None, port=None, snr=None, dns_success=None, connection_status=None, sub_type=None, location=None, host_mac=None):  # noqa: E501
        """ClientDetailResponseResponseDetail - a model defined in OpenAPI"""  # noqa: E501
