...
class RegisterNetworkDeviceResultResponse(object):
    ...
    def __init__(self, mac_address=None, serial_number=None, name=None, tenant_id=None, model_number=None):  # noqa: E501
        """RegisterNetworkDeviceResultResponse - a model defined in OpenAPI"""  # noqa: E501
